  ...
  return (
    <>
      ...
      <div className=' my-3'>
        ...
        <p>NoteSaver is a powerful and intuitive web application designed to simplify your note-taking experience. Whether you're a student, professional, or just someone who loves jotting down thoughts, NoteKeep is here to help you capture and organize your ideas effortlessly.</p>
      </div>
      <div className=' my-3'>
        <h4>Our Mission: </h4>
        <p>At NoteSaver, our mission is to empower you to stay organized and focused. We understand that life can be fast-paced and chaotic, and important thoughts or information can slip through the cracks. Our web app is built with the goal of providing a seamless and efficient note-taking platform, ensuring you never lose track of essential ideas again.</p>
      </div>
      <div className=' my-3'>
        <h4>Key Features: </h4>
        <p>
